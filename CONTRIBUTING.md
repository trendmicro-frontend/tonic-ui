...
This monorepo uses [Changesets](https://github.com/changesets/changesets) for versioning and changelogs management. Changesets help in documenting updates, ensuring consistent versioning, and generating changelogs automatically. If you make changes to versioned packages, be sure to add a new changeset to document these updates.
