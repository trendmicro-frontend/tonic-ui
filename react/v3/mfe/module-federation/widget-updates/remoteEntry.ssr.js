  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__widget_updates__remoteEntry_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    ...
    const initToken = { from: "widget_updates" };
