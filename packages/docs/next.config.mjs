...
export default withPlugins([
  ...
  withMDX(),
  {
    env: {
      ...
      TONIC_UI_MAIN_BRANCH_NAME: process.env.TONIC_UI_MAIN_BRANCH_NAME,
      TONIC_UI_MAIN_BRANCH_DOCUMENTATION: process.env.TONIC_UI_MAIN_BRANCH_DOCUMENTATION,
      TONIC_UI_MAIN_BRANCH_SOURCE_CODE: process.env.TONIC_UI_MAIN_BRANCH_SOURCE_CODE,
    },
