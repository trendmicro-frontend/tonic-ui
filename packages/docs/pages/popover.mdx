    ...
    >
      ...
      <PopoverContent>
        ...
        >
          ...
          <Stack flexDirection="row" spacing="2x">
...
```jsx
<Stack shouldWrapChildren flexDirection="row" spacing="2x">
...
```jsx
<Stack flexDirection="column" spacing="8x">
  <Stack shouldWrapChildren flexDirection="row" spacing="8x">
...
| Name | Type | Default | Description |
| :--- | :--- | :------ | :---------- |
| children | | | If the children is a function, it will be called with `{ getPopoverTriggerProps }` and the return value will be used as the trigger. |
