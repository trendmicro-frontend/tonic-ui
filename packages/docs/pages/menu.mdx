...
The distance from the trigger to the menu can be controlled by passing a `distance` prop to `MenuList`. This value is specified in pixels.
...
The offset of the menu along the trigger can be controlled by passing a `skidding` prop to `MenuList`. This value is specified in pixels.
...
| distance | number | `0` | The distance from the trigger to the menu. It is specified in pixels. |
| skidding | number | `0` | The offset of the menu along the trigger. It is specified in pixels. |
