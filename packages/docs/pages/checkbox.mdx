...
```jsx
<Stack flexDirection="row" spacing="6x">
...
```jsx
<Stack flexDirection="row" spacing="6x" alignItems="center">
...
function IndeterminateExample() {
  ...
  return (
    <>
      ...
      />
      <Stack flexDirection="column" pl="6x" mt="1x" spacing="1x" shouldWrapChildren>
        <Checkbox
