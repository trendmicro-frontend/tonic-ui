...
- feat(react-hooks): add SSR-safe `useId` hook with React 18 integration by [@cheton](https://github.com/cheton) in [#1051](https://github.com/trendmicro-frontend/tonic-ui/pull/1051)
