...
const WipeSVGIcon = (
  ...
  return (
    <SVGIcon ref={ref} viewBox="0 0 16 16" {...styleProps} {...props}>
      <g><path key="wipe-0" d="M6.114 5.93c1.738 1.828 3.823 3.308 6.152 4.336l0.122 0.048c-0.762 1.903-2.114 3.436-3.826 4.408l-0.043 0.023c-0.265 0.152-0.583 0.241-0.921 0.241-0.037 0-0.074-0.001-0.11-0.003l0.005 0c-5.606-0.379-7.493-6.983-7.493-6.983 2.292-0.193 4.378-0.938 6.166-2.101l-0.052 0.031zM12.14 6.355l-0.248-0.186 4.108-4.108-1.061-1.061-4.26 4.26-0.498-0.373c-0.33-0.249-0.748-0.399-1.2-0.399-0.426 0-0.821 0.133-1.145 0.359l0.007-0.004c-0.247 0.169-0.534 0.356-0.84 0.551 1.587 1.643 3.478 2.981 5.583 3.925l0.114 0.046c0.094-0.331 0.175-0.736 0.229-1.149l0.005-0.045c0.007-0.064 0.011-0.138 0.011-0.213 0-0.654-0.314-1.235-0.8-1.599l-0.005-0.004z" /></g>
    </SVGIcon>
  )
};

if (process.env.NODE_ENV !== 'production') {
  WipeSVGIcon.displayName = 'WipeSVGIcon';
}
export default React.forwardRef(WipeSVGIcon);