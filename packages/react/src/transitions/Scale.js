 ...
 * @property {[number, number]} [initialScale] - The initial scale values [sx, sy] for the component when exiting.
...
/**
 * @type {ForwardRefComponent<'div', ScaleProps>}
 */
