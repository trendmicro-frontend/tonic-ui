...
- feat(react-icons): add `column-add` and `column-delete` icons by [@cheton](https://github.com/cheton) in [#1205](https://github.com/trendmicro-frontend/tonic-ui/pull/1205)
