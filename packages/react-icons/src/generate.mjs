...
function doNoEdit() {
  return '// GENERATED BY src/generate.mjs\n// DO NOT EDIT THIS FILE\n';
}
...
`
  ...
  const entryText = Object.keys(iconDefinitions)
    .sort()
    .map(
      (key) => `export { default as ${iconDefinitions[key].svgIdentifier} } from './${iconDefinitions[key].svgIdentifier}';`
    )
    .join('\n');
...
// clean up ./icons
fs.readdirSync(path.resolve(__dirname, outDir)).forEach((file) => fs.unlinkSync(path.resolve(__dirname, outDir, file)));
