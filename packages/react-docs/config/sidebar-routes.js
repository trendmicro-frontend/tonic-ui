...
export const routes = [
  {
    ...
    routes: [
      ...
      { title: 'React Components', path: 'getting-started/contributing/react-components' },
      { title: 'Documentation Site', path: 'getting-started/contributing/documentation-site' },
