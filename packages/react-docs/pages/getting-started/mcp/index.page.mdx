# Model Context Protocol (MCP) for Tonic UI

A Model Context Protocol (MCP) server that provides access to Tonic UI documentation and resources. It enables AI agents to access detailed information about Tonic UI, including:
