...
import {
  Box,
  TonicProvider,
  ToastProvider, // "ToastProvider" is only required if you want to use toast notification
  useColorMode,
  useTheme,
} from '@tonic-ui/react';
...
> Learn more about [Color Mode](../system/color-mode) and [Color Style](../system/color-style) in the documentation.
