...
⚠️ This is the Tonic UI migration guide for upgrading from v0 to v1. You have to consider whether you will do the upgrade if the breaking changes are not acceptable to you at the moment. A proper way for the migration is to make v0 and v1 coexist for a while, then remove v0 packages once you have finished the migration.
