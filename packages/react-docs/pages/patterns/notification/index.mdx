import { Box, Flex, Grid, Image, Stack, TextLabel } from '@tonic-ui/react';
...
![image](../patterns/notification/notification-center-1.png)
...
![image](../patterns/notification/notification-center-2.png)
...
![image](../patterns/notification/product-level-alert.png)
...
<Stack spacing="6x">
  <Stack spacing="2x">
    <Image src="../patterns/notification/in-app-alert.png" width="fit-content" />
    <TextLabel>Alert on the screen</TextLabel>
  </Stack>
  <Stack spacing="2x">
    <Image src="../patterns/notification/modal-alert.png" width="fit-content" />
    <TextLabel>Alert on a modal</TextLabel>
  </Stack>
  <Stack spacing="2x">
    <Image src="../patterns/notification/drawer-alert.png" width="fit-content" />
    <TextLabel>Alert on a drawer</TextLabel>
  </Stack>
</Stack>
