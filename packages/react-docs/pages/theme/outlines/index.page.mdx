...
<ThemeTokens type="primitive" scales={[{ name: 'outlines', defaultIsExpanded: true }]} />

### Primitive tokens (v3)

<ThemeTokens type="legacy" scales={[{ name: 'outlines', defaultIsExpanded: true }]} />
