...
Pass `justifyContent` on the `TabList` to align the tabs to the left, center, or right.
* `justifyContent="flex-start"` - Aligns the tabs to the left
* `justifyContent="center"` - Aligns the tabs to the center
* `justifyContent="flex-end"` - Aligns the tabs to the left
...
| `variant` | string | 'line' | The visual style of the tab. One of: `line`,`enclosed`, `unstyled` |
