...
To prevent this, pass `portalled` to the `OverflowTooltip`. This will position the tooltip at the document root.
...
To resolve this issue, set `portalled` on `OverflowTooltip`.
