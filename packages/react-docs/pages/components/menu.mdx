...
Use [Dropdown](https://github.com/trendmicro-frontend/tonic-ui/tree/master/packages/react-docs/components/Dropdown.jsx) when you can select only one option from a list at a time.
...
Use [Multiselect](https://github.com/trendmicro-frontend/tonic-ui/tree/master/packages/react-docs/components/Dropdown.jsx) when you want to select multiple options from a list or to filter information.
