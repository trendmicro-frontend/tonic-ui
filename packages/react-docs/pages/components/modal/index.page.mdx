...
| closeOnEsc | boolean | false | If `true`, close the modal when the `Escape` key is pressed. |
| closeOnInteractOutside | boolean | false | If `true`, close the modal when interacting outside the modal content. |
| closeOnOutsideClick | boolean | false | If `true`, close the modal when clicking outside the modal content. |
