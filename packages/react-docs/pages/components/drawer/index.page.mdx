...
| closeOnEsc | boolean | false | If `true`, close the drawer when the `Escape` key is pressed. |
| closeOnInteractOutside | boolean | false | If `true`, close the drawer when interacting outside the drawer content. |
| closeOnOutsideClick (deprecated) | boolean | false | If `true`, close the drawer when clicking outside the drawer content. |
