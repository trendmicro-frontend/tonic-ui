...
Use the `variant` prop to change the visual style of every button in a group. You can set the value to `default` or `secondary`.
...
| variant | string | 'default' | The variant of the button group. One of: 'default', 'secondary' |
