  ...
  return (
    <>
      ...
      <FormGroup>
        ...
        <Box ml="6x">
          <Text mb="2x">
            Body scroll lock can be used to prevent the user from scrolling the page while the modal is open.
          </Text>
          <Text>
            You can use <Code>{`import { Global } from '@emotion/react';`}</Code> and dynamically inject the global style as shown below:
          </Text>
          <pre>
      ...
      <FormGroup>
        ...
        <Box ml="6x">
          <Text mb="2x">
            Enable this option will increase the content height to overflow the viewport.
          </Text>
          <Text>
