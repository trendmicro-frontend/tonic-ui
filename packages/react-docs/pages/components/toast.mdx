...
Toasts can be rendered inside a modal. It is usually horizontally centered and vertically aligned to the top of the modal with a 48px margin.

The minimum toast width 280px. If the content is wider than 280px, it should expand to fit the content without exceeding 80% of the modal width.
...
render(() => {
  ...
  const handleClickToast1 = () => {
    setToast(prevState => ({
      ...prevState,
      appearance: 'success',
      content: 'This is a toast alert.',
    }));
  ...
  const handleClickToast2 = () => {
    setToast(prevState => ({
      ...prevState,
      appearance: 'success',
      content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec pretium ante erat, vitae sodales mi varius quis. Etiam vestibulum lorem vel urna tempor, eu fermentum odio aliquam. Aliquam consequat urna vitae ipsum pulvinar, in blandit purus eleifend.',
    }));
  ...
  return (
    ...
    >
      ...
      <ModalFooter columnGap="2x" justifyContent="space-between">
        <Flex columnGap="2x">
          <Button onClick={handleClickToast1}>
            Show Toast
          </Button>
          <Button onClick={handleClickToast2}>
            Show Another Toast
          </Button>
        </Flex>
        <Button onClick={handleClickClearToast}>
          Clear Toast
        </Button>
      </ModalFooter>
    </ModalContent>
