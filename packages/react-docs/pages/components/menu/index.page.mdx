...
import DropdownSource from '!!raw-loader!@/components/Dropdown';
import DropdownBaseSource from '!!raw-loader!@/components/DropdownBase';
...
<Accordion rowGap={1}>
  <AccordionItem defaultIsExpanded>
    <AccordionHeader>`Dropdown` component source</AccordionHeader>
    <AccordionBody><CodeBlock code={DropdownSource} /></AccordionBody>
  </AccordionItem>
  <AccordionItem defaultIsExpanded>
    <AccordionHeader>`DropdownBase` component source</AccordionHeader>
    <AccordionBody><CodeBlock code={DropdownBaseSource} /></AccordionBody>
  </AccordionItem>
</Accordion>
