...
The `Dropdown` component enables users to select a single option from a list. It provides a simple interface for managing dropdown selections.
...
{render('../../experiments/dropdown/usage')}
