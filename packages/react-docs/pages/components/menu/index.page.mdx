...
import rawDropdown from '!!raw-loader!@/components/Dropdown';
...
<Accordion rowGap={1}>
  <AccordionItem defaultIsExpanded>
    ...
    <AccordionBody><CodeBlock code={rawDropdown} /></AccordionBody>
  </AccordionItem>
  <AccordionItem defaultIsExpanded>
    <AccordionHeader>`DropdownBase` component source</AccordionHeader>
    <AccordionBody><CodeBlock code={rawDropdownBase} /></AccordionBody>
  </AccordionItem>
</Accordion>
