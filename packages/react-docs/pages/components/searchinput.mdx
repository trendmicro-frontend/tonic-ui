...
The `SearchInput` component comes in 3 variants: `outline`, `filled`, and `flush`. Pass the `variant` prop and set it to either of these values.
...
| variant | string | 'outline' | The variant of the input style to use. One of: 'outline', 'filled', 'flush' |
