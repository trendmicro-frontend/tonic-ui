...
First, you need to wrap your root component with the `PortalProvider` component. This provides a context for `usePortal` to work. Then, you can use the `usePortal` Hook in any component to create and remove portals.
