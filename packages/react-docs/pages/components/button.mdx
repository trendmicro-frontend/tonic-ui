...
<Stack direction="column" spacing="4x">
  <Stack direction="row" spacing="2x" alignItems="center">
    <Button variant="emphasis">Normal</Button>
    <Button variant="emphasis" selected>Selected</Button>
    <Button variant="emphasis" disabled>Disabled</Button>
  </Stack>
  <Stack direction="row" spacing="2x" alignItems="center">
  ...
  <Stack direction="row" spacing="2x" alignItems="center">
    ...
    <Button variant="ghost" selected>Selected</Button>
