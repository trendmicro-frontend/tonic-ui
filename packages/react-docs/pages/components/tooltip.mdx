...
Text that is longer than the container width will be truncated and a tooltip will be displayed.
...
>
  <Box maxWidth={240}>
    <Tooltip
      label="This is a very long text string that will be truncated"
      display="block"
      whiteSpace="nowrap"
