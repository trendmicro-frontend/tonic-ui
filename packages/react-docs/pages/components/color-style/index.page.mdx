...
The `severity`, `chart`, and `gradient` color values provided here are examples and are not defined in the color style system. You can customize your own color values as needed.

### Severity (deprecated in v2)

> The severity color values have been deprecated since v2 and will be removed in the next major release.
>
...
### Chart (deprecated in v2)

> The chart color values have been deprecated since v2 and will be removed in the next major release.
>
