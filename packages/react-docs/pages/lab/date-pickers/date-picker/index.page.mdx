...
Note that the `DateInput` component is currently not provided by the `@tonic-ui/react-lab` package. You have to write your own or refer to the following code to [get started](../../components/input-control).
