...
function App({ children }) {
  return (
    <TonicProvider
       ...
       */
      colorStyle={{
        defaultValue: defaultColorStyle, // Not required when using default color style
      }}
    >
      {children}
    </ColorModeProvider>
...
To manage color style in your application, you can use the `useColorStyle` hook.
