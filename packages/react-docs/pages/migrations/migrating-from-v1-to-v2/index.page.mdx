...
> The following keys in the color style are deprecated and will be removed in the next major release. Please update your code with the [recommended configuration](#color-style) to avoid encountering breaking changes in the future.

Type | Key | Configuration
:-- | :-- | :--
[Severity (deprecated)](../../components/color-style) | `colorStyle.severity.*` | [View](../../components/color-style)
[Chart (deprecated)](../../components/color-style) | `colorStyle.chart.classic.colors[]` | [View](../../components/color-style)
...
The [DateCalendar](../../components/date-pickers/date-calendar) and [DatePicker](../../components/date-pickers/date-picker) components have been moved from `@tonic-ui/react-lab` to `@tonic-ui/react`. You can import them as follows:
