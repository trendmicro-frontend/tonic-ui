...
> The following keys in the color style are deprecated and will be removed in the next major release. Please update your code with the recommended configuration to avoid encountering breaking changes in the future.
