...
3. Select the new version tag (e.g., `@tonic-ui/react@x.y.z`) and the previous tag to compare.
...
Here is an example of how the release notes might look for `@tonic-ui/react`:
