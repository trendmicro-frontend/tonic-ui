...
| :--- | :--- | :------ | :---------- |
| initialValue | * \| function | | Initial value, or function to get the initial value. Similar to `useState`, only the value/function passed in the first time this is called is respected. |
