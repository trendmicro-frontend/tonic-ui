...
const initialNextConfig = {
  env: {
    ...
    // v3-next
    TONIC_UI_V3_BRANCH: process.env.TONIC_UI_V3_BRANCH,
    TONIC_UI_V3_DOCUMENTATION: process.env.TONIC_UI_V3_DOCUMENTATION,
    TONIC_UI_V3_SOURCE_CODE: process.env.TONIC_UI_V3_SOURCE_CODE,
    TONIC_UI_V3_TAGNAME: process.env.TONIC_UI_V3_TAGNAME,
    TONIC_UI_V3_RELEASE_VERSION: process.env.TONIC_UI_V3_RELEASE_VERSION,
    TONIC_UI_V3_RELEASE_DOCUMENTATION: process.env.TONIC_UI_V3_RELEASE_DOCUMENTATION,
    TONIC_UI_V3_RELEASE_NOTES: process.env.TONIC_UI_V3_RELEASE_NOTES,
    // v2
