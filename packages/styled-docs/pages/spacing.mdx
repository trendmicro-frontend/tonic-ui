...
<>
  <div>
    <Box display="inline-block" mr="1x" size="10x" bg="gray:70"/> 
    <Box display="inline-block" size="10x" bg="gray:70"/> 
  </div>
  <div>
    <Box display="inline-block" mr="2x" size="10x" bg="gray:70"/> 
    <Box display="inline-block" size="10x" bg="gray:70"/> 
  </div>
  <div>
    <Box display="inline-block" mr="3x" size="10x" bg="gray:70"/> 
    <Box display="inline-block" size="10x" bg="gray:70"/> 
  </div>
</>
```
