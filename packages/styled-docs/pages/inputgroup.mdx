...
Change the size on the individual input group elements is not supported.
...
```jsx
<InputGroup variant="unstyled">
  <Input placeholder="YYYY" borderBottom={1} width="12x" />
  <Text px="2x">-</Text>
  <Input placeholder="MM" borderBottom={1} width="8x" />
  <Text px="2x">-</Text>
  <Input placeholder="DD" borderBottom={1} width="8x" />
</InputGroup>
```
