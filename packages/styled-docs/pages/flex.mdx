...
const FlexItem = (props) => (
  <Box bg="blue:50" border={1} borderColor="blue:60" p="3x" mr="4x" mb="4x" {...props} />
);

function Example() {
  return (
    <>
      <Flex bg="gray:20" p="4x" pb={0} pr={0} mb="4x">
      ...
      <Flex bg="gray:20" p="4x" pb={0} pr={0}>
...
function Example() {
  ...
  return (
    <>
      ...
      <Flex direction={value} bg="gray:20" p="4x" pb={0} pr={0}>
...
function Example() {
  ...
  return (
    <>
      ...
      <Flex wrap={value} width={480} bg="gray:20" p="4x" pb={0} pr={0}>
...
function Example() {
  ...
  return (
    <>
      ...
      <Flex align={value} height={240} bg="gray:20" p="4x" pb={0} pr={0}>
        <FlexItem flex="auto">One</FlexItem>
        <FlexItem flex="auto">Two</FlexItem>
        <FlexItem flex="auto">Three</FlexItem>
      </Flex>
...
function Example() {
  ...
  return (
    <>
      ...
      <Flex justify={value} bg="gray:20" p="4x" pb={0} pr={0}>
