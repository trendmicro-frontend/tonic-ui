...
Use the `variantColor` prop to change the checked background color of the Toggle Switch. `variantColor` can be any color key with key `50`(hover), `60`(checked, focus) that exist in the theme.color.
