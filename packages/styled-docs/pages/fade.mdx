...
| from | `object | { opacity: 0 } | Base values, optional |
| enter | `object` | { opacity: 1 } | Styles apply for entering elements, optional |
| leave | `object` | { opacity: 0 } | Styles apply for leaving elements, optional |
