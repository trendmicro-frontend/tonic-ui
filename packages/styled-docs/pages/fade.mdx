...
This component uses [react-spring](https://github.com/react-spring/react-spring) for animating.
...
| from | `object` or `function` | { opacity: 0 } | Base values, optional |
| enter | `object`  or `function` | { opacity: 1 } | Styles apply for entering elements, optional |
| leave | `object`  or `function` | { opacity: 0 } | Styles apply for leaving elements, optional |
