...
<Box position="relative" height="32x">
  <Box position="absolute" zIndex="popover" left="4x" p="4x" bg="gray:80">z-index=popover</Box>
  <Box position="absolute" zIndex="toast" top="9x" p="4x" bg="gray:70">z-index=toast</Box>
</Box>
```
