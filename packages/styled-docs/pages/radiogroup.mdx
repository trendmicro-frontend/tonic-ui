...
Make a set of radios appear horizontal stacked rather than vertically, by adding `inline` to the `RadioGroup` component.
...
<Stack direction="column" spacing="1rem">
  <RadioGroup inline spacing="2x" size="sm">
    <Radio value="1">Radio 1</Radio>
    <Radio value="2">Radio 2</Radio>
    <Radio value="3">Radio 3</Radio>
  </RadioGroup>
  <RadioGroup inline spacing="2x" size="md">
    <Radio value="1">Radio 1</Radio>
    <Radio value="2">Radio 2</Radio>
    <Radio value="3">Radio 3</Radio>
  </RadioGroup>
  <RadioGroup inline spacing="2x" size="lg">
    <Radio value="1">Radio 1</Radio>
    <Radio value="2">Radio 2</Radio>
    <Radio value="3">Radio 3</Radio>
  </RadioGroup>
...
| inline | `boolean` | false | If `true`, the radios will aligned horizontally. |
...
| spacing | `string` or `number` | `1x` | The space between each radio item. |
