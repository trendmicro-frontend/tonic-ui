...
```jsx disabled
const DocsIcon = React.forwardRef((props, ref) => (
  <SVGIcon
    ref={ref}
    fontSize="1.5rem"
    mx=".75rem"
...
```jsx
<>
  <DocsIcon color="red.40" />
  <DocsIcon color="magenta.40" />
  <DocsIcon color="purple.40" />
  <DocsIcon color="blue.40" />
  <DocsIcon color="green.40" />
  <DocsIcon color="teal.40" />
  <DocsIcon color="cyan.40" />
  <DocsIcon color="gray.40" />
  <DocsIcon color="orange.50" />
  <DocsIcon color="yellow.50" />
</>
```
...
```jsx
<>
  <DocsIcon fontSize="xs" />
  <DocsIcon fontSize="sm" />
  <DocsIcon fontSize="lg" />
  <DocsIcon fontSize="xl" />
  <DocsIcon fontSize="2xl" />
  <DocsIcon fontSize="3xl" />
  <DocsIcon fontSize="4xl" />
</>
```

## Props

`SVGIcon` composes the [`Box`](./box) component. You can override the default styles with style props.
