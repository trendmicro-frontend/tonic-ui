...
<Stack direction="column" spacing="4x">
  <Alert severity="success">
    <Heading fontWeight="semibold" mb="1x">Success</Heading>
    This is a success alert.
  </Alert>
  <Alert severity="info">
    <Heading fontWeight="semibold" mb="1x">Info</Heading>
    This is an info alert.
  </Alert>
  <Alert severity="warning">
    <Heading fontWeight="semibold" mb="1x">Warning</Heading>
    This is a warning alert.
  </Alert>
  <Alert severity="error">
    <Heading fontWeight="semibold" mb="1x">Error</Heading>
    This is an error alert.
  </Alert>
</Stack>
```
