...
| defaultPlacement | string | 'top-right' | Set the default placement to place toasts. One of: `'top'`, `'top-right'`, `'top-left'`, `'bottom'`, `'bottom-left'`, `'bottom-right'` |
...
### toast.defaultPlacement

The default placement will be used to place toasts if the placement option is not explicitly specified when calling `toast.notify()`.
