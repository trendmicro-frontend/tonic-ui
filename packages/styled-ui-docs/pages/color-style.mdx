...
<CodeBlock>
  {jsonPrettify({
    gradient: {
      ...
      color1: ['purple:50', 'magenta:40'],
      color2: ['purple:60', 'blue:50'],
      color3: ['blue:50', 'teal:40'],
      color4: ['cyan:40', 'teal:30'],
      color5: ['blue:60', 'teal:40'],
      color6: ['green:40', 'cyan:30'],
      color7: ['magenta:60', 'red:40'],
      color8: ['magenta:50', 'blue:60'],
    },
  })}
</CodeBlock>
