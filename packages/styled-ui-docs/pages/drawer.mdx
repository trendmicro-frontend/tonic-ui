...
function Example() {
  ...
  const [isToastNotificationVisible, toggleIsToastNotificationVisible] = useToggle(false);
  ...
  return (
    <>
      ...
      <FormGroup>
        <TextLabel display="flex" alignItems="center">
          <Checkbox checked={isToastNotificationVisible} onChange={toggleIsToastNotificationVisible} />
          <Space width="2x" />
          <Text fontFamily="mono" whiteSpace="nowrap">Toggle Toast</Text>
        </TextLabel>
      </FormGroup>
      <Drawer
      ...
      >
        ...
        <DrawerContent height={height}>
          {isHeaderVisible && (
            <DrawerHeader>
              {size === 'auto' && <Text>Auto-sized Drawer Title</Text>}
              {size === 'sm' && <Text>Small Drawer Title</Text>}
              {size === 'md' && <Text>Medium Drawer Title</Text>}
              {size === 'lg' && <Text>Large Drawer Title</Text>}
              {size === 'full' && <Text>Full-width Drawer Title</Text>}
            </DrawerHeader>
          )}
          <Flex
            justify="center"
            ...
            maxWidth="80%"
          >
            <Fade in={isToastNotificationVisible}>
              <Toast
                appearance="warning"
                isCloseButtonVisible
                onClose={toggleIsToastNotificationVisible}
              >
                <Text>This is a warning toast notification.</Text>
              </Toast>
            </Fade>
          </Flex>
          {isBodyVisible && (
