...
```js
import SVGIcon from '@trendmicro/react-styled-ui/SVGIcon';
// or
import { SVGIcon } from '@trendmicro/react-styled-ui';
```
...
`SVGIcon` composes the [`PseudoBox`](./pseudobox) component. You can override the default styles with style props.
