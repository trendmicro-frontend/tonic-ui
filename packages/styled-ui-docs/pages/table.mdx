...
function ResizableTable() {
  ...
  const resizingStyle = {
    'dark': {
      borderRight: 1,
      borderColor: 'gray:50',
      boxShadow: '4px 0px 0px 0px rgba(255, 255, 255, 0.1)',
    },
    'light': {
      borderRight: 1,
      borderColor: 'gray:70',
      boxShadow: '4px 0px 0px 0px rgba(0, 0, 0, 0.1)',
    },
  }[colorMode];
                    ...
                    <TableHeaderCell {...column.getHeaderProps()}>
                      ...
                      {!isLastChild && (
                        <Box
                          ...
                          top="0"
                          zIndex={1}
                          {...column.isResizing && resizingStyle}
                          {...(hoveredResizerId === cellId) && hoveringStyle}
