...
function Sample() {
  ...
  const data = React.useMemo(() => [
    { id: 1, eventType: 'Virus/Malware', detections: 634 },
    { id: 2, eventType: 'Spyware/Grayware', detections: 634 },
    { id: 3, eventType: 'URL Filtering', detections: 598 },
    { id: 4, eventType: 'Web Reputation', detections: 598 },
    { id: 5, eventType: 'Network Virus', detections: 497 },
    { id: 6, eventType: 'Application Control', detections: 0 }
  ], []);
