...
<Menu>
  <MenuButton>Select an option</MenuButton>
  <MenuList>
    <MenuItem><TMIcon icon="delete" mr="2x"/>List item</MenuItem>
    <MenuItem><TMIcon icon="edit" mr="2x"/>List item</MenuItem>
    <MenuItem><TMIcon icon="share" mr="2x"/>List item</MenuItem>
  </MenuList>
</Menu>
```
