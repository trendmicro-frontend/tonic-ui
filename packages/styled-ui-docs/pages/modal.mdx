...
function SizeExample() {
  ...
  return (
    <>
      ...
      <Modal onClose={onClose} variantSize={size} isOpen={isOpen}>
        <ModalOverlay />
        <ModalContent>
...
| variantSize        | `'xs'`, `'sm'`, `'md'`, `'lg'`, `'xl'`, `'full'` |  `'md'`                  | The size of the modal |
...
### Other Props
- `ModalContent` composes [`PseudoBox`](./pseudobox). You can override the default styles with style props.
