...
<Scrollbar
  ...
  borderColor="#424242"
>
  <Lorem count={12} style={{ whiteSpace: 'nowrap', paddingLeft: '16px' }}  />
</Scrollbar>
```
...
| visibility | string | 'auto' | Acceptable values: `'auto'`, `'visible'`, `'hidden'`. If `'auto'`, the scrollbar will auto show/hide. If `'visible'`, the scrollbar always to show.  If `'hidden'`, the scrollbar always to hide. |
