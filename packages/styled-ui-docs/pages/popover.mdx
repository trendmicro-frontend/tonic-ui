...
import Popover, {
  ...
  PopoverBody,
  PopoverFooter,
} from'@trendmicro/react-styled-ui/Popover';
```
...
| showDelay          | number                                                       | `0`      | If `trigger` is hover, delay showing the popover (ms).                                                                                                                                                                                                                                                     |
| hideDelay          | number                                                       | `100`    | If `trigger` is hover, delay hiding the popover (ms).                                                                                                                                                                                                                                                      |
