...
<Stack direction="column" spacing="2rem">
  <Stack shouldWrapChildren direction="row" spacing="2rem">
    <Popover placement="top" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="top-start" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="top-end" hasCloseButton>
      <PopoverTrigger>
  ...
  <Stack shouldWrapChildren direction="row" spacing="2rem">
    <Popover placement="right" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="right-start" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="right-end" hasCloseButton>
      <PopoverTrigger>
  ...
  <Stack shouldWrapChildren direction="row" spacing="2rem">
    <Popover placement="bottom" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="bottom-start" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="bottom-end" hasCloseButton>
      <PopoverTrigger>
  ...
  <Stack shouldWrapChildren direction="row" spacing="2rem">
    <Popover placement="left" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="left-start" hasCloseButton>
      <PopoverTrigger>
    ...
    <Popover placement="left-end" hasCloseButton>
      <PopoverTrigger>
