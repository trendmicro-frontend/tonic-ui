...
<Stack direction="row" spacing="1rem">
  ...
  <Icon icon="spinner" size="6x" spin animationDuration="4s" />
  <Icon icon="clock" size="6x" spin animationTimingFunction="steps(8)" />
  <Icon icon="redo" size="6x" spin="cw" />
  <Icon icon="undo" size="6x" spin="ccw" />
</Stack>
```
