    ...
    <Stack direction="column" spacing="4x">
      <Flex position="relative" alignItems="center">
        <InputAdornmentPrepend>
          <TMIcon icon="mobile" color={adornmentColor} />
        </InputAdornmentPrepend>
        <Input
      ...
      <Flex position="relative" alignItems="center">
        ...
        <InputAdornmentAppend>
          <TMIcon icon="check" color="green:50" />
        </InputAdornmentAppend>
      </Flex>
      <Flex position="relative" alignItems="center">
        <Input
        ...
        <InputAdornmentAppend>
          <ButtonBase onClick={toggleView}>
            <TMIcon icon={adornmentIconName} color={adornmentColor} />
          </ButtonBase>
        </InputAdornmentAppend>
      </Flex>
    </Stack>
      ...
      <Flex position="relative" alignItems="center" mb="1x">
        ...
        {isInvalid && (
          <Box position="absolute" right={0}>
            <TMIcon icon="warning-circle" mx="3x" color="red:50" />
          </Box>
        )}
      </Flex>
      <Box>
