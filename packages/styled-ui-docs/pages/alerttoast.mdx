...
const AlertToastWithAnotherIcon = ({ onClose }) => (
  <AlertToast severity="success" icon="_core.severity-success">
    This is a success toast alert.
  </AlertToast>
);
...
const AlertToastWithoutIcon = ({ onClose }) => (
  <AlertToast severity="success" icon={false}>
    This is a success toast alert.
  </AlertToast>
);
