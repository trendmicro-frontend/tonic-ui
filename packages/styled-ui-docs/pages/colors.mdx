...
<FunctionalColorPalettes type="blindness" palette="risk" />

#### Chart color

<FunctionalColorPalettes type="blindness" palette="chart" />

#### Gradient color

<FunctionalColorPalettes type="blindness" palette="gradient" />
